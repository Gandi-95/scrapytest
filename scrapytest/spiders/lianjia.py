...
class LianjiaSpider(scrapy.Spider):
    ...
    def parse_house(self, response):
        ...
        item['title'] = response.xpath('//div[@class="content"]/div[@class="title"]/h1/@title').extract_first("")
        ...
        item['price'] = response.xpath('//div[@class="unitPrice"]/span[@class="unitPriceValue"]/text()').extract_first("") + response.xpath('//div[@class="unitPrice"]/span[@class="unitPriceValue"]/i/text()').extract_first("")
        ...
        item['residential'] = response.xpath('//div[@class="communityName"]/a[@class="info "]/text()').extract_first("")
        ...
        item['house_type'] = house_info[1].xpath('./text()').extract_first("")
        item['floor_area'] = house_info[3].xpath('./text()').extract_first("")
        item['carpet_area'] = house_info[5].xpath('./text()').extract_first("")
        item['floor'] = house_info[2].xpath('./text()').extract_first("")
        item['renovation'] = house_info[9].xpath('./text()').extract_first("")
        item['elevator'] = house_info[10].xpath('./text()').extract_first("")
